...
@section('content')
    <div class="row mb-2">
        <div class="col-md-6">
            <a href="{{ route('absensi.sakit') }}" class="btn btn-block btn-gradient-primary">DATA SAKIT</a>
        </div>
        <div class="col-md-6">
            <a href="{{ route('absensi.izin') }}" class="btn btn-block btn-gradient-warning">DATA IZIN</a>
        </div>
    </div>
    <div class="card">
        <form>
